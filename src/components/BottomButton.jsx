  ...
  return (
    <div className="my-8 flex justify-center">
      <button
        ...
        className={`${variant==="home" ?"pl-2 pr-4":"pl-4 pr-2"} flex items-center gap-x-1 rounded bg-ltPrimary py-2 font-sansMed text-base uppercase leading-3 text-white transition-colors duration-200 hover:bg-primaryHover`}>
